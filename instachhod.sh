...
printf "\e[1;95m╔════════════════════════════════════════════════╗\e[0m\n"
printf "\e[1;95m║      \e[1;91m▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓      \e[1;95m║\e[0m\n"
printf "\e[1;95m║      \e[1;91m██╗███╗   ██╗███████╗████████╗ █████╗      \e[1;95m║\e[0m\n"
printf "\e[1;95m║      \e[1;91m██║████╗  ██║██╔════╝╚══██╔══╝██╔══██╗     \e[1;95m║\e[0m\n"
printf "\e[1;95m║      \e[1;91m██║██╔██╗ ██║███████╗   ██║   ███████║     \e[1;95m║\e[0m\n"
printf "\e[1;95m║      \e[1;91m██║██║╚██╗██║╚════██║   ██║   ██╔══██║     \e[1;95m║\e[0m\n"
...
printf "\e[1;95m╚════════════════════════════════════════════════╝\e[0m\n"
printf "\n"
printf "\e[1;77m\e[41m  INSTAGRAM Ki CHODNE WALA v1.0, DEVELOPER: @Prateek_Hacker (Telegram Username)  \e[0m\n" # i am prateek and Don't change, noob
printf "\n"
}


function start() {
read -p $'\e[1;92mMADARCHHOD KA USERNAME: \e[0m' user
...
checkroot() {
if [[ "$(id -u)" -ne 0 ]]; then
    printf "\e[1;77mBHAIYO OR BHENO, ISKO ROOTED! DEVICE PE CHALANA\n\e[0m"
    exit 1
fi
}
...
command -v tor > /dev/null 2>&1 || { echo >&2 "I tor download karke aaye tab chlana. ye daal ke download karle ./install.sh. Aborting."; exit 1; }
command -v curl > /dev/null 2>&1 || { echo >&2 "I curl download karke aaye tab chlana. ye daal ke download karle ./install.sh. Aborting."; exit 1; }
command -v openssl > /dev/null 2>&1 || { echo >&2 "I openssl download karke aaye tab chlana. ye daal ke download karle ./install.sh Aborting."; exit 1; }
...
if [[ -n "$threads" ]]; then
printf "\n"
printf "\e[1;91m [*] OK WAIT SHUTTING DOWN...\n\e[0m"
